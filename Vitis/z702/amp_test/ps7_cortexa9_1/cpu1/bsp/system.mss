...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -g -DUSE_AMP=1  -Wall -Wextra -fno-tree-loop-distribute-patterns
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = axiled
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axiled_0
END
