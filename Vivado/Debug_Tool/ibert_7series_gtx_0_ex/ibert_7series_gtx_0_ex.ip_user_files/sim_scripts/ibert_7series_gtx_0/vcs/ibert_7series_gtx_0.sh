...
#
# Script generated by Vivado on Thu Mar 28 11:51:23 +0800 2024
...
#
# Usage        : ibert_7series_gtx_0.sh
#                ibert_7series_gtx_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ibert_7series_gtx_0.sh [-reset_run]
#                ibert_7series_gtx_0.sh [-reset_log]
#                ibert_7series_gtx_0.sh [-help]
#
...
#                script (type 'ibert_7series_gtx_0.sh -help' for more information).
#
...
# script info
echo -e "ibert_7series_gtx_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ibert_7series_gtx_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ibert_7series_gtx_0_ex.gen/sources_1/ip/ibert_7series_gtx_0/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ibert_7series_gtx_0 xil_defaultlib.glbl -o ibert_7series_gtx_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ibert_7series_gtx_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ibert_7series_gtx_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ibert_7series_gtx_0_simv.daidir vcs_lib c.obj)
...
Usage: ibert_7series_gtx_0.sh [-step]\n\
Usage: ibert_7series_gtx_0.sh [-lib_map_path]\n\
Usage: ibert_7series_gtx_0.sh [-reset_run]\n\
Usage: ibert_7series_gtx_0.sh [-reset_log]\n\
Usage: ibert_7series_gtx_0.sh [-keep_index]\n\
