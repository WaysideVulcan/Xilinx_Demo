...
HD_PWD='C:/Vulcan/Design_Tool/Vivado/FPGA_LED/FPGA_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_led.tcl
