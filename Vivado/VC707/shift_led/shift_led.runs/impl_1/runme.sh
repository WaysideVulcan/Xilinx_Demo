...
HD_PWD='C:/Vulcan/Design_Tool/Vivado/FPGA_LED/FPGA_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_led.tcl -notrace
