...
#
# Script generated by Vivado on Wed Apr 24 13:30:34 +0800 2024
...
#
# Usage        : ram.sh
#                ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram.sh [-reset_run]
#                ram.sh [-reset_log]
#                ram.sh [-help]
#
...
#                script (type 'ram.sh -help' for more information).
#
...
# script info
echo -e "ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ram -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ram.sh [-reset_log]\n\
Usage: ram.sh [-keep_index]\n\
