...
HD_PWD='C:/Vulcan/Design_Tool/Vivado/VC707/fifo/fifo.runs/asfifo_wr256x8_rd256x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asfifo_wr256x8_rd256x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asfifo_wr256x8_rd256x8.tcl
