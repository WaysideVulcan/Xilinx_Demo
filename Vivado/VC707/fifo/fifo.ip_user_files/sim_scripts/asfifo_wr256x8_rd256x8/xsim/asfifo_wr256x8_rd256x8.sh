...
#
# Script generated by Vivado on Wed Apr 24 08:36:36 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : asfifo_wr256x8_rd256x8.sh
...
#
# Usage        : asfifo_wr256x8_rd256x8.sh
#                asfifo_wr256x8_rd256x8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                asfifo_wr256x8_rd256x8.sh [-reset_run]
#                asfifo_wr256x8_rd256x8.sh [-reset_log]
#                asfifo_wr256x8_rd256x8.sh [-help]
#
...
# script info
echo -e "asfifo_wr256x8_rd256x8.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./asfifo_wr256x8_rd256x8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot asfifo_wr256x8_rd256x8 xil_defaultlib.asfifo_wr256x8_rd256x8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim asfifo_wr256x8_rd256x8 -key {Behavioral:sim_1:Functional:asfifo_wr256x8_rd256x8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb asfifo_wr256x8_rd256x8.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./asfifo_wr256x8_rd256x8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: asfifo_wr256x8_rd256x8.sh [-help]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-step]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-lib_map_path]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-reset_run]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-reset_log]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-keep_index]\n\
Usage: asfifo_wr256x8_rd256x8.sh [-noclean_files]\n\n\
