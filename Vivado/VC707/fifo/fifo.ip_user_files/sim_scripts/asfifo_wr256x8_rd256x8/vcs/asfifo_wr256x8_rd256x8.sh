...
#                script (type 'asfifo_wr256x8_rd256x8.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.asfifo_wr256x8_rd256x8 xil_defaultlib.glbl -o asfifo_wr256x8_rd256x8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./asfifo_wr256x8_rd256x8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key asfifo_wr256x8_rd256x8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc asfifo_wr256x8_rd256x8_simv.daidir vcs_lib c.obj)
