...
HD_PWD='C:/Vulcan/Design_Tool/Vivado/VC707/vga/vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_shift.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_shift.tcl
