...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_vresampled_dout { I 24 vector } stream_out_vresampled_num_data_valid { I 3 vector } stream_out_vresampled_fifo_cap { I 3 vector } stream_out_vresampled_empty_n { I 1 bit } stream_out_vresampled_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val7_dout { I 12 vector } height_val7_num_data_valid { I 3 vector } height_val7_fifo_cap { I 3 vector } height_val7_empty_n { I 1 bit } height_val7_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val12_dout { I 13 vector } width_val12_num_data_valid { I 3 vector } width_val12_fifo_cap { I 3 vector } width_val12_empty_n { I 1 bit } width_val12_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fid_in_val14_dout { I 1 vector } fid_in_val14_num_data_valid { I 4 vector } fid_in_val14_fifo_cap { I 4 vector } fid_in_val14_empty_n { I 1 bit } fid_in_val14_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { field_id_val13_dout { I 16 vector } field_id_val13_num_data_valid { I 4 vector } field_id_val13_fifo_cap { I 4 vector } field_id_val13_empty_n { I 1 bit } field_id_val13_read { O 1 bit } } \
} "
}
