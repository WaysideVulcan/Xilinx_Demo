...
set C_modelArgList {
	...
	{ field_id_val13_load int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sof", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fid_in_val14_load", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "colorFormat_val_load", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "field_id_val13_load", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fid_in_val14_load sc_in sc_lv 1 signal 3 } 
	{ fid sc_out sc_lv 1 signal 4 } 
	{ fid_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ stream_out_vresampled_dout sc_in sc_lv 24 signal 5 } 
	{ stream_out_vresampled_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ stream_out_vresampled_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ stream_out_vresampled_empty_n sc_in sc_logic 1 signal 5 } 
	{ stream_out_vresampled_read sc_out sc_logic 1 signal 5 } 
	{ colorFormat_val_load sc_in sc_lv 8 signal 6 } 
	...
	{ field_id_val13_load sc_in sc_lv 16 signal 14 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fid_in_val14_load", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "fid_in_val14_load", "role": "default" }} , 
 	...
 	{ "name": "colorFormat_val_load", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "colorFormat_val_load", "role": "default" }} , 
 	...
 	{ "name": "field_id_val13_load", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "field_id_val13_load", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	fid_in_val14_load { ap_none {  { fid_in_val14_load in_data 0 1 } } }
	...
	colorFormat_val_load { ap_none {  { colorFormat_val_load in_data 0 8 } } }
	...
	field_id_val13_load { ap_none {  { field_id_val13_load in_data 0 16 } } }
