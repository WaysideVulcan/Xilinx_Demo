...
reg   [31:0] count;
reg   [31:0] s;
wire   [0:0] icmp_ln500_fu_574_p2;
reg   [0:0] icmp_ln500_reg_656;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln502_fu_584_p2;
reg   [31:0] add_ln502_reg_660;
reg   [15:0] height_read_reg_669;
wire    ap_CS_fsm_state4;
reg   [15:0] width_read_reg_674;
reg   [15:0] field_id_read_reg_679;
reg   [7:0] bckgndId_read_reg_689;
reg   [7:0] ovrlayId_read_reg_694;
reg   [7:0] maskId_read_reg_699;
reg   [7:0] motionSpeed_read_reg_704;
reg   [7:0] colorFormat_read_reg_709;
reg   [15:0] crossHairX_read_reg_714;
reg   [15:0] crossHairY_read_reg_719;
reg   [15:0] ZplateHorContStart_read_reg_724;
reg   [15:0] ZplateHorContDelta_read_reg_729;
reg   [15:0] ZplateVerContStart_read_reg_734;
reg   [15:0] ZplateVerContDelta_read_reg_739;
reg   [15:0] boxSize_read_reg_744;
wire   [7:0] empty_fu_641_p1;
reg   [7:0] empty_reg_749;
wire   [7:0] empty_103_fu_646_p1;
reg   [7:0] empty_103_reg_754;
wire   [7:0] empty_104_fu_651_p1;
reg   [7:0] empty_104_reg_759;
reg   [7:0] dpYUVCoef_read_reg_764;
wire   [23:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TDATA;
wire   [2:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TKEEP;
wire   [2:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TSTRB;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TUSER;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TLAST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TID;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TDEST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_405_fid;
wire    grp_v_tpgHlsDataFlow_fu_405_ap_start;
wire    grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TVALID;
wire    grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_405_fid_ap_vld;
wire    grp_v_tpgHlsDataFlow_fu_405_ap_done;
wire    grp_v_tpgHlsDataFlow_fu_405_ap_ready;
wire    grp_v_tpgHlsDataFlow_fu_405_ap_idle;
reg    grp_v_tpgHlsDataFlow_fu_405_ap_continue;
wire   [15:0] grp_reg_unsigned_short_s_fu_568_ap_return;
reg   [31:0] count_new_0_reg_394;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln503_fu_590_p2;
reg    grp_v_tpgHlsDataFlow_fu_405_ap_start_reg;
wire    ap_CS_fsm_state5;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_ready;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_done;
reg    ap_block_state5_on_subcall_done;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done;
wire   [31:0] select_ln505_fu_621_p3;
wire   [28:0] tmp_2_fu_599_p4;
wire   [0:0] icmp_ln505_fu_609_p2;
wire   [31:0] add_ln507_fu_615_p2;
...
#0 count = 32'd0;
#0 s = 32'd0;
#0 grp_v_tpgHlsDataFlow_fu_405_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done = 1'b0;
end

design_1_v_tpg_0_0_v_tpgHlsDataFlow grp_v_tpgHlsDataFlow_fu_405(
    ...
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .field_id_val13_ap_vld(1'b1),
    .fid_in_val14_ap_vld(1'b1),
    .ovrlayId_val16_ap_vld(1'b1),
    .maskId_val17_ap_vld(1'b1),
    .colorFormat_val_ap_vld(1'b1),
    .crossHairX_val22_ap_vld(1'b1),
    .crossHairY_val23_ap_vld(1'b1),
    .boxSize_val28_ap_vld(1'b1),
    .boxColorR_val29_ap_vld(1'b1),
    .boxColorG_val30_ap_vld(1'b1),
    .boxColorB_val31_ap_vld(1'b1),
    .ap_start(grp_v_tpgHlsDataFlow_fu_405_ap_start),
    .height_val7_ap_vld(1'b1),
    .width_val12_ap_vld(1'b1),
    .bckgndId_val15_ap_vld(1'b1),
    .ZplateHorContStart_val24_ap_vld(1'b1),
    .ZplateHorContDelta_val25_ap_vld(1'b1),
    .ZplateVerContStart_val26_ap_vld(1'b1),
    .ZplateVerContDelta_val27_ap_vld(1'b1),
    .dpYUVCoef_val32_ap_vld(1'b1),
    .motionSpeed_val19_ap_vld(1'b1),
    .s_ap_vld(1'b1),
...
design_1_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_568(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .d(bck_motion_en),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_405_ap_done == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_405_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_v_tpgHlsDataFlow_fu_405_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
            grp_v_tpgHlsDataFlow_fu_405_ap_start_reg <= 1'b1;
        end else if ((grp_v_tpgHlsDataFlow_fu_405_ap_ready == 1'b1)) begin
            grp_v_tpgHlsDataFlow_fu_405_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((icmp_ln503_fu_590_p2 == 1'd0)) begin
            count_new_0_reg_394 <= add_ln502_reg_660;
        end else if ((icmp_ln503_fu_590_p2 == 1'd1)) begin
            count_new_0_reg_394 <= 32'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln500_reg_656 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        count <= count_new_0_reg_394;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln503_fu_590_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state5_on_subcall_done) & (1'b1 == ap_CS_fsm_state5))) begin
        grp_v_tpgHlsDataFlow_fu_405_ap_continue = 1'b1;
    end else begin
        grp_v_tpgHlsDataFlow_fu_405_ap_continue = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln500_fu_574_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln502_fu_584_p2 = (count + 32'd1);

assign add_ln507_fu_615_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_ready & ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_done) == 1'b0);
end
...
assign ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_done = (grp_v_tpgHlsDataFlow_fu_405_ap_done | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_done);

assign ap_sync_grp_v_tpgHlsDataFlow_fu_405_ap_ready = (grp_v_tpgHlsDataFlow_fu_405_ap_ready | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_405_ap_ready);

assign empty_103_fu_646_p1 = boxColorG[7:0];

assign empty_104_fu_651_p1 = boxColorB[7:0];

assign empty_fu_641_p1 = boxColorR[7:0];

assign fid = grp_v_tpgHlsDataFlow_fu_405_fid;

assign grp_v_tpgHlsDataFlow_fu_405_ap_start = grp_v_tpgHlsDataFlow_fu_405_ap_start_reg;

assign grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state5);

assign icmp_ln500_fu_574_p2 = ((grp_reg_unsigned_short_s_fu_568_ap_return == 16'd1) ? 1'b1 : 1'b0);

assign icmp_ln503_fu_590_p2 = ((add_ln502_reg_660 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln505_fu_609_p2 = (($signed(tmp_2_fu_599_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_v_tpgHlsDataFlow_fu_405_m_axis_video_TVALID;

assign select_ln505_fu_621_p3 = ((icmp_ln505_fu_609_p2[0:0] == 1'b1) ? add_ln507_fu_615_p2 : 32'd0);

assign tmp_2_fu_599_p4 = {{s[31:3]}};
