...
attribute shreg_extract : string;
    ...
    signal fid_in_val14_blk_n : STD_LOGIC;
    signal field_id_val13_blk_n : STD_LOGIC;
    signal colorFormat_val_read_reg_289 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal fid_in_val14_read_reg_294 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_stream_out_vresampled_read : STD_LOGIC;
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, height_val7_empty_n, width_val12_empty_n, colorFormat_val_empty_n, fid_in_val14_empty_n, field_id_val13_empty_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (field_id_val13_empty_n = ap_const_logic_0) or (fid_in_val14_empty_n = ap_const_logic_0) or (colorFormat_val_empty_n = ap_const_logic_0) or (width_val12_empty_n = ap_const_logic_0) or (height_val7_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    fid_in_val14_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, fid_in_val14_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            fid_in_val14_blk_n <= fid_in_val14_empty_n;
        else 
            fid_in_val14_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    fid_in_val14_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            fid_in_val14_read <= ap_const_logic_1;
        else 
            fid_in_val14_read <= ap_const_logic_0;
        end if; 
    end process;


    field_id_val13_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, field_id_val13_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            field_id_val13_blk_n <= field_id_val13_empty_n;
        else 
            field_id_val13_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    field_id_val13_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            field_id_val13_read <= ap_const_logic_1;
        else 
            field_id_val13_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    icmp_ln979_fu_217_p2 <= "1" when (width_val12_dout = ap_const_lv13_0) else "0";
    m_axis_video_TDATA <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TDATA;
    m_axis_video_TDEST <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TDEST;
    m_axis_video_TID <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TID;
    m_axis_video_TKEEP <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TKEEP;
    ...
    stream_out_vresampled_read_assign_proc : process(grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_stream_out_vresampled_read, ap_CS_fsm_state3)
    begin
    ...
    sub_i_fu_211_p2 <= std_logic_vector(unsigned(width_val12_dout) + unsigned(ap_const_lv13_1FFF));
