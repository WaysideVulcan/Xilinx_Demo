...
architecture behav of design_1_v_tpg_0_0_v_tpgHlsDataFlow_Block_entry38_proc is 
...
attribute shreg_extract : string;
    ...
    signal bPassThru_fu_12_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= bPassThru_fu_12_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, bPassThru_fu_12_p2, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= bPassThru_fu_12_p2;
        else 
            ap_return <= ap_return_preg;
        end if; 
    end process;

    bPassThru_fu_12_p2 <= (p_read xor ap_const_lv1_1);
end behav;
