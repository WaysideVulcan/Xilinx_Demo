...
-- Date        : Thu Nov 30 10:21:31 2023
-- Host        : LAPTOP-90IBO783 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/va/z702/breath_led/breath_led.gen/sources_1/bd/design_1/ip/design_1_axiled_0_0/design_1_axiled_0_0_sim_netlist.vhdl
...
entity design_1_axiled_0_0_breath_led is
  port (
    led : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_axiled_0_0_breath_led : entity is "breath_led";
end design_1_axiled_0_0_breath_led;

architecture STRUCTURE of design_1_axiled_0_0_breath_led is
  ...
  signal \period_cnt[15]_i_3_n_0\ : STD_LOGIC;
  signal \period_cnt[15]_i_4_n_0\ : STD_LOGIC;
  signal \period_cnt[15]_i_5_n_0\ : STD_LOGIC;
  signal \period_cnt[3]_i_2_n_0\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_0\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_1\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_2\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_3\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_4\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_5\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_6\ : STD_LOGIC;
  signal \period_cnt_reg[11]_i_1_n_7\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_1\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_2\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_3\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_4\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_5\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_6\ : STD_LOGIC;
  signal \period_cnt_reg[15]_i_2_n_7\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_1\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_2\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_3\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_4\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_5\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_6\ : STD_LOGIC;
  signal \period_cnt_reg[3]_i_1_n_7\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_0\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_1\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_2\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_3\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_4\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_5\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_6\ : STD_LOGIC;
  signal \period_cnt_reg[7]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_period_cnt_reg[15]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \period_cnt_reg[11]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \period_cnt_reg[15]_i_2\ : label is 11;
  attribute ADDER_THRESHOLD of \period_cnt_reg[3]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \period_cnt_reg[7]_i_1\ : label is 11;
begin
...
\duty_cycle[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
        ...
        port map (
      I0 => \period_cnt[15]_i_5_n_0\,
      I1 => \duty_cycle[0]_i_20_n_0\,
      I2 => \period_cnt[15]_i_4_n_0\,
...
\period_cnt[15]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^out\(3),
      I4 => \^out\(2),
      I5 => \period_cnt[15]_i_5_n_0\,
      O => \period_cnt[15]_i_3_n_0\
    );
\period_cnt[15]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
\period_cnt[15]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\period_cnt[3]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^out\(0),
      O => \period_cnt[3]_i_2_n_0\
    );
\period_cnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[3]_i_1_n_7\,
      Q => \^out\(0),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[11]_i_1_n_5\,
      Q => \^out\(10),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[11]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[11]_i_1_n_4\,
      Q => \^out\(11),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[11]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \period_cnt_reg[7]_i_1_n_0\,
      CO(3) => \period_cnt_reg[11]_i_1_n_0\,
      CO(2) => \period_cnt_reg[11]_i_1_n_1\,
      CO(1) => \period_cnt_reg[11]_i_1_n_2\,
      CO(0) => \period_cnt_reg[11]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \period_cnt_reg[11]_i_1_n_4\,
      O(2) => \period_cnt_reg[11]_i_1_n_5\,
      O(1) => \period_cnt_reg[11]_i_1_n_6\,
      O(0) => \period_cnt_reg[11]_i_1_n_7\,
...
\period_cnt_reg[15]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[15]_i_2_n_4\,
      Q => \^out\(15),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[15]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \period_cnt_reg[11]_i_1_n_0\,
      CO(3) => \NLW_period_cnt_reg[15]_i_2_CO_UNCONNECTED\(3),
      CO(2) => \period_cnt_reg[15]_i_2_n_1\,
      CO(1) => \period_cnt_reg[15]_i_2_n_2\,
      CO(0) => \period_cnt_reg[15]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \period_cnt_reg[15]_i_2_n_4\,
      O(2) => \period_cnt_reg[15]_i_2_n_5\,
      O(1) => \period_cnt_reg[15]_i_2_n_6\,
      O(0) => \period_cnt_reg[15]_i_2_n_7\,
...
\period_cnt_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[3]_i_1_n_4\,
      Q => \^out\(3),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \period_cnt_reg[3]_i_1_n_0\,
      CO(2) => \period_cnt_reg[3]_i_1_n_1\,
      CO(1) => \period_cnt_reg[3]_i_1_n_2\,
      CO(0) => \period_cnt_reg[3]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \period_cnt_reg[3]_i_1_n_4\,
      O(2) => \period_cnt_reg[3]_i_1_n_5\,
      O(1) => \period_cnt_reg[3]_i_1_n_6\,
      O(0) => \period_cnt_reg[3]_i_1_n_7\,
      S(3 downto 1) => \^out\(3 downto 1),
      S(0) => \period_cnt[3]_i_2_n_0\
    );
\period_cnt_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[7]_i_1_n_7\,
      Q => \^out\(4),
      R => \period_cnt[15]_i_1_n_0\
    );
...
\period_cnt_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \period_cnt_reg[7]_i_1_n_4\,
      Q => \^out\(7),
      R => \period_cnt[15]_i_1_n_0\
    );
\period_cnt_reg[7]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \period_cnt_reg[3]_i_1_n_0\,
      CO(3) => \period_cnt_reg[7]_i_1_n_0\,
      CO(2) => \period_cnt_reg[7]_i_1_n_1\,
      CO(1) => \period_cnt_reg[7]_i_1_n_2\,
      CO(0) => \period_cnt_reg[7]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \period_cnt_reg[7]_i_1_n_4\,
      O(2) => \period_cnt_reg[7]_i_1_n_5\,
      O(1) => \period_cnt_reg[7]_i_1_n_6\,
      O(0) => \period_cnt_reg[7]_i_1_n_7\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axiled_0_0_axiled_v1_0_S00_AXI is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    cnt_flag : out STD_LOGIC_VECTOR ( 15 downto 0 );
    led : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_axiled_0_0_axiled_v1_0_S00_AXI : entity is "axiled_v1_0_S00_AXI";
end design_1_axiled_0_0_axiled_v1_0_S00_AXI;

architecture STRUCTURE of design_1_axiled_0_0_axiled_v1_0_S00_AXI is
...
u_breath_led: entity work.design_1_axiled_0_0_breath_led
     port map (
      Q(10) => slv_reg1(31),
      ...
      led => led,
      \out\(15 downto 0) => cnt_flag(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axiled_0_0_axiled_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_axiled_0_0_axiled_v1_0 : entity is "axiled_v1_0";
end design_1_axiled_0_0_axiled_v1_0;

architecture STRUCTURE of design_1_axiled_0_0_axiled_v1_0 is
begin
axiled_v1_0_S00_AXI_inst: entity work.design_1_axiled_0_0_axiled_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
      cnt_flag(15 downto 0) => cnt_flag(15 downto 0),
      led => led,
      s00_axi_aclk => s00_axi_aclk,
...
entity design_1_axiled_0_0 is
  ...
  attribute NotValidForBitStream of design_1_axiled_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_axiled_0_0 : entity is "design_1_axiled_0_0,axiled_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_axiled_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_axiled_0_0 : entity is "axiled_v1_0,Vivado 2023.2";
end design_1_axiled_0_0;

architecture STRUCTURE of design_1_axiled_0_0 is
...
inst: entity work.design_1_axiled_0_0_axiled_v1_0
     port map (
