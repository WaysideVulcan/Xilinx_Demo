...
#
# Script generated by Vivado on Wed Jan 24 10:45:00 +0800 2024
...
#
# Usage        : timer.sh
#                timer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                timer.sh [-reset_run]
#                timer.sh [-reset_log]
#                timer.sh [-help]
#
...
#                script (type 'timer.sh -help' for more information).
#
...
# script info
echo -e "timer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./timer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../timer.gen/sources_1/bd/timer/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" +incdir+"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.timer xil_defaultlib.glbl -o timer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./timer_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key timer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc timer_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./timer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: timer.sh [-help]\n\
Usage: timer.sh [-step]\n\
Usage: timer.sh [-lib_map_path]\n\
Usage: timer.sh [-reset_run]\n\
Usage: timer.sh [-reset_log]\n\
Usage: timer.sh [-keep_index]\n\
Usage: timer.sh [-noclean_files]\n\n\
