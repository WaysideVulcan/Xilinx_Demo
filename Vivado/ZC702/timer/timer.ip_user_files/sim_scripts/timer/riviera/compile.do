...
vlog -work axi_infrastructure_v1_1_0  -incr -v2k5 "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" "+incdir+C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" -l xilinx_vip -l axi_infrastructure_v1_1_0 -l axi_vip_v1_1_15 -l processing_system7_vip_v1_0_17 -l xil_defaultlib \
"../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_vip_v1_1_15  -incr "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" "+incdir+C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" -l xilinx_vip -l axi_infrastructure_v1_1_0 -l axi_vip_v1_1_15 -l processing_system7_vip_v1_0_17 -l xil_defaultlib \
"../../../../timer.gen/sources_1/bd/timer/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \

vlog -work processing_system7_vip_v1_0_17  -incr "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" "+incdir+C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" -l xilinx_vip -l axi_infrastructure_v1_1_0 -l axi_vip_v1_1_15 -l processing_system7_vip_v1_0_17 -l xil_defaultlib \
"../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \

vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/ec67/hdl" "+incdir+../../../../timer.gen/sources_1/bd/timer/ipshared/6b2b/hdl" "+incdir+C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" -l xilinx_vip -l axi_infrastructure_v1_1_0 -l axi_vip_v1_1_15 -l processing_system7_vip_v1_0_17 -l xil_defaultlib \
