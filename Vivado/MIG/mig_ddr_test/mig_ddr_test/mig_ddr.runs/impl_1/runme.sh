...
HD_PWD='C:/Vivadolab/mig_ddr_test/mig_ddr_test/mig_ddr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_ddr_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mig_ddr_test.tcl -notrace
