...
HD_PWD='G:/V2020/S02/02_example_mig_ddr-35t/01_mig_ddr_test/mig_ddr_test/mig_ddr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_ddr_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_ddr_test.tcl
