...
set_property PACKAGE_PIN E21 [get_ports tg_compare_error]
set_property IOSTANDARD LVCMOS33 [get_ports tg_compare_error]

set_property PACKAGE_PIN D21 [get_ports init_calib_complete]
...
connect_debug_port u_ila_0/probe3 [get_nets [list app_rd_data_valid_r]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list tg_compare_error_OBUF]]
